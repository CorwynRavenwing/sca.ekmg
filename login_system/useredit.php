...
<html>
<title><?=SITE_NAME?> Login Script</title>
<body>
...
if(isset($_SESSION['useredit'])){
   ...
   echo "<p><b>$session->username</b>, your account has been successfully updated. "
       ."<a href='".HOME_PAGE."' target='_parent'>Main</a>.</p>";
} else {
	/**
...
<h1>User Account Edit : <? echo $session->username; ?></h1>
   ...
   echo "<td><font size=\"2\" color=\"#ff0000\">".$form->num_errors." error(s) found</font></td>";
		...
		if($session->is_limited_user()) {
			?>
<h2><font color="red">ERROR: can't edit this user's information.</font></h2>
			<?
		} else {
			?>
<form action="process.php" method="POST" target="_self">
...
<tr><td colspan="2" align="left"></td></tr>
			...
			<?
		} // endif is_limited_user
	} else {
		echo "<h1>Not logged in!</h1>\n";
	} // endif logged_in
} // endif session useredit
?>
