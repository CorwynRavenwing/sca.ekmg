...
#
DROP TABLE IF EXISTS logon_users;
...
#
DROP TABLE IF EXISTS logon_active_users;

CREATE TABLE logon_active_users (
 username varchar(30) primary key,
 timestamp int(11) unsigned not null
);
...
#
DROP TABLE IF EXISTS logon_active_guests;

CREATE TABLE logon_active_guests (
...
#
DROP TABLE IF EXISTS logon_banned_users;

CREATE TABLE logon_banned_users (
 username varchar(30) primary key,
 timestamp int(11) unsigned not null
);
